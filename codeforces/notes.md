...
Key insight: for every new character at position i, we can generate n-i substrings. Process: instead of trying to generate substrings and cache, think through how many unique substrings can be generated by applying first and second operation.
